"""Class for loading the IAM handwritten text dataset, which encompasses both paragraphs and lines,
plus utilities.
"""
...
class IAM:
    ...
    handwritten text, which were scanned at a resolution of 300dpi and saved as PNG images with
    256 gray levels."
...
def _get_ids_from_lwitlrt_split_file(filename: str) -> list[str]:
    """
    Get the ids from Large Writer Independent Text Line Recognition Task
    (LWITLRT) data split file.
    """
